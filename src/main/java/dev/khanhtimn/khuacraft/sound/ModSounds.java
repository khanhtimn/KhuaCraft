...
public class ModSounds {
    ...
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS = DeferredRegister.create(BuiltInRegistries.SOUND_EVENT, KhuaCraft.MODID);
    ...
    public static final Holder<SoundEvent> INNER_CONSCIENCE = SOUND_EVENTS.register(
            "inner_conscience",
