...
public class ModTags {
    ...
    public static class Blocks {
        private static TagKey<Block> bind(String name) {
            return BlockTags.create(ResourceLocation.fromNamespaceAndPath(KhuaCraft.MODID, name));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> bindMod(String name) {
            return ItemTags.create(ResourceLocation.fromNamespaceAndPath(KhuaCraft.MODID, name));
        }
    }
    ...
    public static class Enchantments {
        ...
        private static TagKey<Enchantment> bindMod(String name) {
            return TagKey.create(Registries.ENCHANTMENT, ResourceLocation.fromNamespaceAndPath(KhuaCraft.MODID, name));
        }
    }
}
